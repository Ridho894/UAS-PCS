...
interface ApiEndPoint {
    ...
    @FormUrlEncoded
    @HTTP(method = "POST", path = "product/product_put", hasBody = true)
    fun putProduk(
        @Header("Authorization") token : String,
        @Field("id") id : Int,
        @Field("admin_id") admin_id : Int,
    ...
    @FormUrlEncoded
    @HTTP(method = "POST", path = "product/product_delete", hasBody = true)
    fun deleteProduk(
        @Header("Authorization") token : String,
        @Field("id") id : Int,
    ) : Call<ProdukResponsePost>
    ...
    @FormUrlEncoded
    @POST("product/item_transaction_post")
    ...
    @GET("product/transaction_this_month")
